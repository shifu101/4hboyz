    ...
    const model = [
        {
            ...
            items: [
                ...
                { label: 'Pending Paid loans', icon: 'pi pi-fw pi-wallet', to: route('loans.index', { status: 'Pending Paid' }), roles: [1, 2, 3] },  
                { label: 'Pending Partially Paid loans', icon: 'pi pi-fw pi-wallet', to: route('loans.index', { status: 'Pending Partially Paid' }), roles: [1, 2, 3] },   
                { label: 'Partially Paid loans', icon: 'pi pi-fw pi-wallet', to: route('loans.index', { status: 'Partially Paid' }), roles: [1, 2, 3] },   
